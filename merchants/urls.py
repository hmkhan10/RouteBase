...
urlpatterns = [
    ...
    path('api/refunds/', views.create_refund, name='create_refund'),
    path('api/refunds/list/', views.list_refunds, name='list_refunds'),
    path('api/payouts/', views.create_payout, name='create_payout'),
    path('api/payouts/list/', views.list_payouts, name='list_payouts'),
    path('api/webhooks/', views.configure_webhook, name='configure_webhook'),
    path('api/webhooks/logs/', views.webhook_logs, name='webhook_logs'),
    path('api/webhooks/trigger/', views.trigger_webhook, name='trigger_webhook'),
    path('webhook/receiver/<str:webhook_secret>/', views.webhook_receiver, name='webhook_receiver'),
