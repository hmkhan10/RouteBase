                    ...
                    <GlassCard className="p-8 md:p-12 rounded-3xl border-white/10">
                        ...
                        <div className="space-y-8 text-muted-foreground leading-relaxed">
                            <section>
                                ...
                                <p>
                                    By accessing and using RouteBases, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p>
                                    Permission is granted to temporarily download one copy of the materials (information or software) on RouteBases's website for personal, non-commercial transitory viewing only.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p>
                                    The materials on RouteBases's website are provided on an 'as is' basis. RouteBases makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p>
                                    In no event shall RouteBases or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on RouteBases's website.
                                </p>
                            </section>
